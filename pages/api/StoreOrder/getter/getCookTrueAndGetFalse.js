    ...
    export default async function handler(req, res) {
        ...
        const allStoreOrder = await StoreOrder.find({ cookStatus: true, getStatus: false }, "orderId orderList.productId orderList.orderQuantity cancelStatus cookStatus getStatus orderTime")
            .populate([
